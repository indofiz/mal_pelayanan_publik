            ...
            <div className="container mx-auto">
                <div className="bg-white max-w-6xl mx-auto px-2 md:px-10 py-6 rounded-2xl shadow-searchShadow">
                    <div className="flex gap-0">
                        <div className="flex-1 flex flex-col items-center gap-2 text-center relative">
                            <div className="absolute top-1/4 right-0 h-[2px] w-1/2 bg-gray-100 z-0"></div>
                        ...
                        <div className="flex-1 flex flex-col items-center gap-2 text-center relative">
                            <div className="absolute top-1/4 right-0 h-[2px] w-1/2 bg-gray-100 z-0"></div>
                            <div className="absolute top-1/4 left-0 h-[2px] w-1/2 bg-gray-100 z-0"></div>
                            <div className="p-1 border-2 border-gray-100 bg-white relative z-10 rounded-full">
