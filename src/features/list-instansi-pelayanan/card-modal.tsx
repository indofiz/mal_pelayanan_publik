...
export const CardModal: React.FC<ICardModal> = ({ jumlah, desc, img }) => {
    return (
        <div className="flex-1 border border-border_card bg-white rounded-2xl p-4 relative z-0 overflow-clip flex items-center gap-4">
            ...
            <div className="flex flex-col gap-1">
                <h3 className="font-semibold text-3xl">{jumlah}</h3>
